<?php
	...
	if(isset($_POST['opcion'])){
		...
		switch ($_POST['opcion']) {
			case 'new_persona':
				$datos = array(1,$_POST['cedula'],$_POST['nombre'],$_POST['apellido'],$_POST['fecha_nac'],$_POST['telefono'],2);
				break;
			case 'edit_persona':
				$datos = array(2,$_POST['cedula'],$_POST['nombre'],$_POST['apellido'],$_POST['fecha_nac'],$_POST['telefono'],2);
				break;
			case 'delete_persona':
